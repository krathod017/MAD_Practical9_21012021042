package com.example.mad_practical9_21012021042
...
import com.example.mad_practical9_21012021042.R
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        alaram_img=findViewById(R.id.alarm_list)
        alaram_img.setBackgroundResource(R.drawable.alarm_animation_list)
